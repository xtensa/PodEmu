        ...
        if (mode == 0x04 && ipod_mode == 0x04) // AiR mode
        {
            switch (cmd)
            {
                ...
                */
                 ...
                 */
                case 0x0033:
                    oap_write_screen_resolution_34();
                    break;
                 ...
                 */
                case 0x0039:
                    oap_write_screen_resolution_3A();
                    break;
            }
